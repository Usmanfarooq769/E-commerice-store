                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                            ...
                            <div
                                class="text-primary p-1 rounded-circle border border-primary border-opacity-25 shadow-sm ms-auto">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="p-2 bg-primary bg-opacity-25 rounded-circle" width="40px" height="40px"
                                    viewBox="0 0 24 24">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                            ...
                            <div
                                class="text-secondary p-1 rounded-circle border border-secondary border-opacity-25 shadow-sm ms-auto">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="p-2 bg-secondary bg-opacity-25 rounded-circle" width="40px" height="40px"
                                    viewBox="0 0 24 24">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                            ...
                            <div
                                class="text-success p-1 rounded-circle border border-success border-opacity-25 shadow-sm ms-auto">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="p-2 bg-success bg-opacity-25 rounded-circle" width="40px" height="40px"
                                    viewBox="0 0 24 24">
                                    <path fill="currentColor"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="p-2 bg-info bg-opacity-25 rounded-circle"
            ...
            <div class="card-body">
                <div class="d-flex gap-3">
                    ...
                    <div class="ms-auto text-end">
                        ...
                        <p class="text-muted fs-13 mb-4">Connect with potential sellers to expand your marketplace and
                            grow your community.</p>
                        <button class="btn btn-primary btn-wave waves-effect waves-light"><i
                                class="ri-mail-add-line me-2 d-inline-block lh-1"></i>Invite Now</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="me-2">
                        <span class="avatar avatar-md avatar-rounded p-1 bg-primary text-fixed-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                ...
                                class="icon icon-tabler icons-tabler-outline icon-tabler-users-plus p-1">
                    ...
                    <table class="table text-nowrap mb-0">
                        ...
                        <tbody class="top-selling">
                            <tr>
                                <td class="text-center lh-1">
                                    <span class="avatar avatar-md">
                                        <img src="../assets/images/media/media-93.jpg" class="rounded-pill bg-light"
                                            alt="">
                                    </span>
                                </td>
                            ...
                            <tr>
                                <td class="text-center lh-1">
                                    <span class="avatar avatar-md">
                                        <img src="../assets/images/ecommerce/png/18.png" class="rounded-pill bg-light"
                                            alt="">
                                    </span>
                                </td>
                            ...
                            <tr>
                                <td class="text-center lh-1">
                                    <span class="avatar avatar-md">
                                        <img src="../assets/images/ecommerce/png/17.png" class="rounded-pill bg-light"
                                            alt="">
                                    </span>
                                </td>
                                <td>Elegant Summer Dress</td>
                                <td>Fashion</td>
                                <td><span class="badge badge-sm bg-danger-transparent text-danger">Out Of Stock</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center lh-1">
                                    <span class="avatar avatar-md">
                                        <img src="../assets/images/ecommerce/png/16.png" class="rounded-pill bg-light"
                                            alt="">
                                    </span>
                                </td>
                                    ...
                                    <div class="btn-list">
                                        <button class="btn btn-sm btn-icon btn-success-light rounded-circle"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"><i
                                                class="ri-pencil-line lh-1 align-middle"></i></button>
                                        <button class="btn btn-sm btn-icon btn-danger-light rounded-circle"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i
                                                class="ri-delete-bin-line lh-1 align-middle"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
