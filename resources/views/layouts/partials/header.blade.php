                         ...
                         <li class="dropdown-item">
                             <div class="d-flex align-items-center gap-3">
                                 ...
                                 <div class="flex-fill">
                                     ...
                                     <div class="fs-11 fw-medium text-default"><span class="text-muted">Qty: </span>01
                                     </div>
                                 </div>
                                 <div class="text-end">
             ...
             <div class="header-element dropdown">
                 ...
                 <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                     ...
                     <span class="avatar avatar-sm avatar-rounded">
                         ...
                         @else
                         <span class="avatar avatar-sm avatar-rounded bg-primary text-fixed-white fw-semibold"
                             style="display:flex; align-items:center; justify-content:center; width:32px; height:32px; border-radius:50%; font-size:14px;">
                 ...
                 <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                     ...
                     <li><a class="dropdown-item d-flex align-items-center"  href="{{ route('admin.users.show', auth()->user()->id) }}"><i
