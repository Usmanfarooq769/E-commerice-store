...
<nav id="mainNav" class="navbar border-bottom py-0">
    <div class="container-fluid flex-nowrap align-items-center px-2 px-sm-3">
        ...
        <div class="d-none d-lg-flex flex-grow-1 justify-content-center px-3">
            <form action="{{ route('products') }}" method="GET" class="d-flex gap-2 w-100" style="max-width:460px;">
                <input type="search" class="form-control form-control-sm" name="search" value="{{ request('search') }}"
        ...
        <div class="d-flex align-items-center gap-1 ms-auto flex-shrink-0">
            ...
            {{-- Home --}}
            <a class="hdr-btn" href="{{ route('products') }}" aria-label="Home" title="Home">
            ...
            <div class="cart-dropdown dropdown">
                <a href="javascript:void(0);" class="hdr-btn dropdown-toggle position-relative"
                    data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-label="Cart" title="Cart">
                    ...
                    <span class="badge bg-primary rounded-pill hdr-cart-badge" id="cart-icon-badge">0</span>
                </a>
            ...
            <a href="javascript:void(0);" class="hdr-btn switcher-icon d-none d-lg-inline-flex"
                data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" aria-label="Settings" title="Settings">
                <svg xmlns="http://www.w3.org/2000/svg" height="21" viewBox="0 0 24 24" width="21" class="hdr-svg">
                    <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            @if(!auth()->check())
            <a href="{{ route('login') }}" class="btn btn-primary hdr-signup d-inline-flex align-items-center gap-1">
                <i class="bi bi-person-plus"></i> Sign Up
            </a>
            @else
            <form method="POST" action="{{ route('logout') }}" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-danger hdr-signup d-inline-flex align-items-center gap-1">
            ...
            <button class="hdr-btn d-lg-none ms-1" type="button" id="mobileToggle" aria-label="Toggle menu"
                aria-expanded="false" aria-controls="mobilePanel">
                <svg id="icoHam" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"
                    class="hdr-svg">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" />
                </svg>
                <svg id="icoClose" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"
...
<div id="mobilePanel" class="d-lg-none border-bottom shadow-sm" style="display:none;
    ...
    <form action="{{ route('products') }}" method="GET" class="mb-3">
        <div class="input-group">
            <input type="search" class="form-control" name="search" id="mobilePanelSearch"
    ...
    <div class="d-flex align-items-center gap-2 pt-1">
        ...
        <a href="javascript:void(0);"
            ...
            data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" aria-label="Settings">
...
[data-theme-mode="dark"] .hdr-svg {
    fill: #adb5bd !important;
}

[data-theme-mode="dark"] .hdr-icon {
