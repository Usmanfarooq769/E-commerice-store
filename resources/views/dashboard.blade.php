                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="p-2 bg-primary bg-opacity-25 rounded-circle"
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                        <div>
                            ...
                            <div class="d-flex gap-2 justify-content-between flex-wrap align-items-center">
                                <div class="fs-12 mb-0">Increased by </div>
                                <div
                                    class="badge {{ $growth >= 0 ? 'bg-success-transparent' : 'bg-danger-transparent' }} rounded-pill">
                                    {{ $growth >= 0 ? '+' : '' }} {{ $growth }}%
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="p-2 bg-success bg-opacity-25 rounded-circle"
                                width="40px" height="40px" viewBox="0 0 24 24">
                                <path fill="currentColor"
                            ...
                            <tr>
                                ...
                                <td class="text-center lh-1">
                                    <span class="avatar avatar-md">
                                        <img src="{{ $item->product?->image_url ?? asset('assets/images/no-image.png') }}"
                                            class="rounded-pill bg-light" alt="">
                                    </span>
                                </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-2 lh-1">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ $order->items->first()?->product?->image_url ?? asset('assets/images/no-image.png') }}"
                                                    alt="">
                                            </span>
                                        </div>
                                        <div class="fs-14">
                                ...
                                <td>
                                    ...
                                    <span class="badge bg-{{ $badge }}-transparent">
                                        {{ ucfirst($status) }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <button
                                            class="btn btn-sm btn-icon btn-danger-light rounded-circle delete-order-btn"
                                            data-id="{{ $order->id }}">
